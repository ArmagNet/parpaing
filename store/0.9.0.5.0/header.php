		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="otb-navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<?php if ($isConnected) {?>
					<li <?php if ($page == "statistics") echo 'class="active"'; ?>><a href="statistics.php"><?php echo lang("menu_status"); ?><?php if ($page == "statistics") echo ' <span class="sr-only">(current)</span>'; ?></a></li>
