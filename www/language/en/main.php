...
You're in a list of validators of the account {account}, and, a tweet is waiting for you on Parpaing here is the content :
...
$lang["mypage_tweet_and_validations_chart_jsFormatDate"] = "(date.getMonth() < 11 ? '0' : '') + (date.getMonth() + 1) + '/' + (date.getDate() < 10 ? '0' : '') + date.getDate() + '/' + date.getFullYear()";

$lang["register_guide"] = "Welcome to the register page of Parpaing";
...
It seems that you registered yourself on Parpaing. To confirm your registration, please click the link below :
{activationUrl}
...
It seems that you forgot your password on Parpaing. Your new password is {password} .
